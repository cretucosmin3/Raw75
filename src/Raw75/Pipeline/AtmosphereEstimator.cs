...
/// <summary>
/// Darktable-grade single-image atmospheric airlight estimator based on
...
internal static class AtmosphereEstimator
{
        ...
        out float depthMax)
    {
        ...
        // 2. Find 95th Percentile of Dark Channel (crit_haze_level in Darktable)
        ...
        if (count > 0)
        {
            ...
            // Darktable distance_max formula: -1.125 * ln(crit_haze_level)
